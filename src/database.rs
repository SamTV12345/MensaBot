...
static QUERY: &str = "CREATE TABLE IF NOT EXISTS public.meal(
    ...
    calendar timestamp with time zone NULL,
...
static INSERT_QUERY: &str = "INSERT INTO meal (id,calendar, counterid, countername, name, \
studentprice) VALUES ($1, $2, $3, $4, $5, $6)";
                        ...
                        match !meal.components.front().is_none() {
                            true => {
                                ...
                                client.execute(INSERT_QUERY,
                                               &[&Uuid::new_v4().to_string(),&item.date, &counter
                                                   .id,&counter
                                                   .display_name,
